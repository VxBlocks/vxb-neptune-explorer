const translation = {
  ...
  account: {
    ...
    studio: 'Pond Agent Workshop Studio',
    avatar: 'Avatar',
    name: 'Name',
    email: 'Email',
    password: 'Password',
    ...
    langGeniusAccount: 'Pond Agent Workshop account',
    langGeniusAccountTip: 'Your Pond Agent Workshop account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Pond Agent Workshop to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Pond Agent Workshop allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Pond Agent Workshop\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Pond Agent Workshop {{version}} is now available.',
    latestAvailable: 'Pond Agent Workshop {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
